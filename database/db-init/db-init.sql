...
CREATE TABLE product (id int primary key, name varchar(50), type varchar(50));
...
# Insert test data
INSERT INTO product values (1, 'Product 1', 'word');
INSERT INTO product values (2, 'Product 2', 'excel');
